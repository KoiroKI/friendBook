    ...
    <div id="container">
        ...
        <div id="loginForm" class="col-4 offset-4 mt-5">
            <form action="login.php" method="post">
                ...
                <input type="passwword" class="form-control mb-3" name="password" id="passwordInput">

                <button type="submit" class="btn btn-primary w-100 mt-3">Zaloguj</button>
                
            </form>
                 <a href="index.php">
                <button class="btn btn-primqry w-100 mt-3">Powrót</button>
                </a>
            <?php
            if(isset($result)) {
                if($result) {
                    echo "Użytkownik zalogowany<br>";
                    echo '<a href="index.php">Przejdż do głównej strony</a>';
                } else {
